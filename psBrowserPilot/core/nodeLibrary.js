...
export const SAMPLE_NODE_TEMPLATES = [
  ...
  },
  {
    ...
    ui: {
      ...
      script: [
        ...
        'if (stored) {',
        '  setStatus(`${stored} を再選択できます。`, \"info\");',
        '}',
        'fetchWorkbooks();',
        'return () => {',
        '  disposed = true;',
  ...
  },
  {
    ...
    execution: 'ui',
    description:
      'Companion UI node that mirrors the built-in Excel selection inspector with four independent outputs.',
    inputs: ['WorkbookName'],
    ...
    ui: {
      ...
      script: [
        ...
        '    updateDisplay({ address, value, fontHex, interiorHex });',
